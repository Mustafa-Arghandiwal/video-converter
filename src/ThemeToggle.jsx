export default function ThemeToggle() {
    return (
        <label className="flex items-center cursor-pointer text-sm animate-fade animate-delay-1000 "> {/* Added 'text-sm' for smaller font size */}
            ...
            <input type="checkbox" value="synthwave" className="toggle theme-controller" style={{ transform: 'scale(0.7)', borderColor: '#93d8e2', backgroundColor: '#93d8e2'  }} /> {/* Added inline style for smaller size */}
